...
function getOverlapAoverB($a_key, $b_key) {
  ...
  if ($a['south_west_lat'] > $b['south_west_lat'] && $a['north_east_lat'] < $b['north_east_lat'] &&
    $a['south_west_lng'] > $b['south_west_lng'] && $a['north_east_lng'] < $b['north_east_lng']) {
    echo $a_key . ' is fully contained by ' . $b_key . "\n";
  }

  // A fully contains B
  elseif ($a['south_west_lat'] < $b['south_west_lat'] && $a['north_east_lat'] > $b['north_east_lat'] &&
    $a['south_west_lng'] < $b['south_west_lng'] && $a['north_east_lng'] > $b['north_east_lng']) {
    echo $a_key . ' fully contains ' . $b_key . "\n";
  }
  ...
  elseif (($a['south_west_lat'] > $b['south_west_lat'] && $a['south_west_lat'] < $b['north_east_lat'] ||
    ...
    ($a['south_west_lng'] > $b['south_west_lng'] && $a['south_west_lng'] < $b['north_east_lng'] ||
    $a['north_east_lng'] > $b['south_west_lng'] && $a['south_west_lng'] < $b['north_east_lng'])) {
    echo $a_key . ' partly contains ' . $b_key . "\n";
  }
